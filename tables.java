...
/*
   try {
        ...
        // Join the 'groupsclg' and 'mentor' tables using a SQL query
        String sql = "SELECT groupsclg.g_id, groupsclg.snum, groupsclg.g_names, groupsclg.leader, groupsclg.contact, groupsclg.project_id, mentor.mentor_id, mentor.mentor_name, mentor.project_id " +
                     "FROM groupsclg " +
                     "LEFT JOIN mentor ON groupsclg.project_id = mentor.project_id";
        ...
        int batch_id = rs.getInt("batch_id");
            ...
            Object[] rowData = {groupid, snum, names, leader, contact, projectid, mentorid, mentorName,batchid, year, stud, status, projectid, domain, type, semester, link_report, name, review, batch_id};
...
try {
    ...
    // Join the 'batch' and 'studentroject' tables using a SQL query
    String sqlJoin = // Join the 'batch' and 'studentroject' tables using a SQL query
"SELECT batch.batch_id, batch.year, batch.numstu, batch.status, studentroject.project_id, studentroject.domain, studentroject.type, studentroject.semester, studentroject.link, studentroject.project_name, studentroject.review, studentroject.batch_id " +
                 "FROM batch " +
                 "LEFT JOIN studentroject ON batch.batch_id = studentroject.batch_id";
    ...
    while (rs.next()) {
        ...
        Object[] rowData = { batchid, year, stud, status, projectid, domain, type, semester, link_report, name, review, batch_id };
        tblModel.addRow(rowData);
    }
